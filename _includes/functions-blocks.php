    ...
    acf_register_block_type(array(
      ...
      acf_register_block_type(array(
        ...
        acf_register_block_type(array(
          ...
          acf_register_block_type(array(
            'name'              => 'three-columns-with-background',
            'title'             => __('Three Columns with background'),
            'description'       => __('A Block for displaying three columns with background.'),
            'render_template'   => '_template-parts/blocks/three-columns-with-background.php',
            'category'          => 'formatting',
            'icon'              => $flag ,
            'keywords'          => array( 'background','three','columns'),
            'post_types'        => array('page'),
            ));
